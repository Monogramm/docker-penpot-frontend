...
-   1.5.2-alpha-debian 1.5-debian debian  (`images/1.5/mainline/Dockerfile`)
-   1.5.2-alpha-alpine 1.5-alpine alpine 1.5.2-alpha 1.5 latest  (`images/1.5/alpine/Dockerfile`)
